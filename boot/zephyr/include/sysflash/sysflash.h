...
#if defined(CONFIG_BOOT_DICE_ROT)
#define FLASH_AREA_IMAGE_SCRATCH    PARTITION_ID(scratch2_partition)
#else /* CONFIG_BOOT_DICE_ROT */
...
#if defined(CONFIG_BOOT_DICE_ROT)
#define FLASH_AREA_IMAGE_PRIMARY(x) PARTITION_ID(mcuboot0_partition)
#define FLASH_AREA_IMAGE_SECONDARY(x) PARTITION_ID(mcuboot0_partition)
#else /* CONFIG_BOOT_DICE_ROT */
...
#define FLASH_AREA_BOOTLOADER       PARTITION_ID(mcuboot0_partition)
#else
